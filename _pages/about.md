...
<div class="research-card">
  <div class="research-card-content">
    <p>
      ...
      <a href="https://www.lti.cs.cmu.edu">Language Technologies Institute</a>, advised by
      <a href="https://strubell.github.io/">Emma Strubell</a> and
...
.research-card {
  ...
  border-radius: 12px;
  border: 3px solid rgba(10, 31, 195, 0.15);
  padding: 16px 24px;
  margin: 20px 0;
  line-height: 1.7;
  overflow: hidden;
